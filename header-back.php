  ...
  <nav class="navbar">
    <div class="nav-links">
      ...
      <ul class="contenant-liste">
        <div id="accueil" class="fond-nav">
          <li class="boutons-liste"><a class="liennav" href="backoffice.php">Accueil</a></li>
        </div>
        <div id="partenariat" class="fond-nav">
          <li class="boutons-liste"><a class="liennav" href="partenaire-back.php">Partenaires</a></li>
        </div>
        <div id="billetterie" class="fond-nav">
          <li class="boutons-liste"><a class="liennav" href="billetterie-back.php">Offres</a></li>
        </div>
        <div id="contact" class="fond-nav">
          <li class="boutons-liste"><a class="liennav" href="contact-back.php">Messagerie</a></li>
        </div>
      </ul>
    </div>
    <div class="dropdown_menu">
      <ul class="contenant-liste">
        ...
        <div id="logout" class="fond-nav">
          <li class="boutons-liste"><a class="liennav" href="logout.php">Déconnexion</a></li>
        </div>
      </ul>
    </div>
